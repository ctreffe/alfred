...
class PageController(object):
    ...
    def __init__(self, experiment):
        ...
        if self._experiment.type == 'qt':
            self._finishedSection.append_pages(CompositePage(elements=[TextElement(u'Das Experiment ist nun beendet. Vielen Dank für die Teilnahme.')]))
        else:
            self._finishedSection.append_pages(WebCompositePage(elements=[TextElement(u'Das Experiment ist nun beendet. Vielen Dank für die Teilnahme.'), WebExitEnabler()]))
    ...
    def append_item_to_finish_section(self, item):
        ...
        self._finishedSection.append_pages(item)
