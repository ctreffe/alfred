...
class QtWebKitUserInterfaceController(WebUserInterfaceController):
    def __init__(self, experiment, weblayout=None, qtlayout=None, full_scren=True, **kwargs):
        ...
        # self._qt_main_scroll_area.setWidgetResizable(True)  # Must be set to True in order for layout to work properly
        # self._qt_main_scroll_area.setStyleSheet("QScrollArea {background: white; border: none}")
