    ...
    *get_condition* is called and display
    ...
    def __init__(
        ...
        *conditions: Tuple[str, int],
        ...
        self._randomizer_id = randomizer_id
    ...
    @property
    def randomizer_id(self):
        return self._randomizer_id
    ...
    def _own_slot(self, data: RandomizerData) -> Slot:
        slot_manager = self.slot_manager(data)
    ...
    def slot_manager(self, data: RandomizerData) -> SlotManager:
